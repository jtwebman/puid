...
const samples = [0n, 1n, 2n, 3n, 61n, 62n, 63n, 1000n, (1n<<64n)-1n, 1n<<64n, (1n<<127n), (1n<<128n)-1n];
...
console.log(`  checked ${N.toLocaleString()} sequential ids: ${collisions} collisions, ${seen.size.toLocaleString()} distinct`);

// 5. "Looks random": sequential ordinals should NOT produce sequential output.
const a = encodePuid(1), b = encodePuid(2), c = encodePuid(3);
